...
The main thing is to get used to the Pytorch syntax and see what it is like to train and evaluate a simple CNN model, so don't get caught up with details. 
